...
\textbf{Dynamic Water Shader and Depth Intersection.} To achieve a stylized, dynamic aquatic environment (Figure \ref{fig:water}), the application utilizes a custom Visual Shader built upon real-time vertex displacement. The geometry of the water mesh is continuously deformed on the Y-axis using a \texttt{FastNoiseLite} cellular texture. To simulate hydrodynamic flow, the UV coordinates of this noise texture are translated frame-by-frame by a time-scaled directional vector.
